...
import { modifyResourceExpireTimeBody } from '@/component/custom/CommonConst'
...
let requestBody = JSON.stringify(modifyResourceExpireTimeBody,null,4);
let URL = "/rest/usg/datacenter/v1/sp/corp/{corpId}/resource";
...
// let proxyId;
//企业修改资源的过期时间API接口调用
class ModifyResourceExpireTime extends React.Component {
...
export default ModifyResourceExpireTime
