...
import { AddCorpDeptBody } from '@/component/custom/CommonConst'
...
let reqBody = JSON.stringify(AddCorpDeptBody,null,4);
let resBody = '';
...
export default class AddCorpDept extends React.Component {
    ...
    handleOnClick = () => {
      ...
      let data = reqBody;
      //添加部门
      post("/add/corp/dept", {data}, headers).then(
        (res) => {
            ...
            <div style={{marginTop: '50px',marginLeft: '10%',width:'100%'}}>
                <div style={{width:'95%'}}>
                    ...
                    <div style={{float:'left',marginLeft: '20px',width:'60%'}}>
                        <Input addonBefore="URL" defaultValue="/rest/usg/datacenter/v1/corp/dept" style={{width:'500px'}} readOnly/>
                    </div>
                </div>
