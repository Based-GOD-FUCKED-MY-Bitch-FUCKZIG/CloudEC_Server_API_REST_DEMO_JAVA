...
import { ModifySpCorpBody } from '@/component/custom/CommonConst'
...
let reqBody = JSON.stringify(ModifySpCorpBody,null,4);
let resBody = '';
let displayValue = 'none';
let statusCodeAndresbody = '';
let URL = "/rest/usg/datacenter/v1/corp"
...
// let proxyId;
//修改企业注册信息API接口调用
export default class ModifySpCorp extends React.Component {
    constructor () {
        super();
        this.state = {
    ...
    handleOnClick = () => {
        ...
        let data = reqBody;
        //修改企业注册信息
        put("/modify/sp/corp", {data}, headers).then(
            (res) => {
