...
import { ModDeviceStatusBody } from '@/component/custom/CommonConst'
...
let URL='/rest/usg/datacenter/v1/corp/device/status/{value}';
let reqBody = JSON.stringify(ModDeviceStatusBody,null,4);
let resBody = '';
...
let proxyId;
//批量修改终端状态API接口调用
export default class ModDeviceStatus extends React.Component {
    constructor () {
        super();
