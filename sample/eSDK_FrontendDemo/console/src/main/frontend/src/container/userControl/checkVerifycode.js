...
import { checkVerifycodeBody } from '@/component/custom/CommonConst'
...
let requestBody = JSON.stringify(checkVerifycodeBody,null,4);
...
let server;
// let proxyId;
//校验手机和邮箱对应的验证码API接口调用
export default class checkVerifycode extends React.Component {
            ...
            <div style={{marginTop: '50px',marginLeft: '10%',width:'100%'}}>
                <div style={{width:'95%'}}>
                    ...
                    <div style={{float:'left',marginLeft: '20px',width:'60%'}}>
                        <Input addonBefore="URL" defaultValue="/member/verification-code" style={{width:'500px'}} readOnly/>
                    </div>
                </div>
