...
import { addCorpUserBody } from '@/component/custom/CommonConst'
...
let requestBody = JSON.stringify(addCorpUserBody,null,4);
...
// let proxyId;
//添加用户API接口调用
export default class addCorpUser extends React.Component {
    ...
    handleOnClick = () => {
        ...
        //添加用户
        post("/corp/member", {data}, headers).then(
          (res) => {
            ...
            <div style={{marginTop: '50px',marginLeft: '10%',width:'100%'}}>
                <div style={{width:'95%'}}>
                    ...
                    <div style={{float:'left',marginLeft: '20px',width:'60%'}}>
                        <Input addonBefore="URL" defaultValue="/corp/member" style={{width:'500px'}} readOnly/>
                    </div>
                </div>
