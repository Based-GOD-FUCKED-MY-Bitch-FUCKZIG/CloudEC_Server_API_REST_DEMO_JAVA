...
import { AddCorpManagerBody } from '@/component/custom/CommonConst'
...
var URL = '/rest/usg/datacenter/v1/corp/admin/{account}'
const TabPane = Tabs.TabPane;
let reqBody = JSON.stringify(AddCorpManagerBody,null,4);
let resBody = '';
...
// let proxyId;
//修改企业管理员API接口调用
export default class ModifyCorpManager extends React.Component {
    constructor () {
        super();
