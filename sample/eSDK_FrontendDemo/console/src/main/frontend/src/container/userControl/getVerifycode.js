...
import { getVerifycodeBody } from '@/component/custom/CommonConst'
...
let requestBody = JSON.stringify(getVerifycodeBody,null,4);
...
// let proxyId;
//获取验证码API接口调用
export default class getVerifycode extends React.Component {
