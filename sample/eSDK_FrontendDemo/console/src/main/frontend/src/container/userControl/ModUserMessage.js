...
let ModUserMessageBody = {"name":"string"};
let requestBody = JSON.stringify(ModUserMessageBody,null,4);
...
// let proxyId;
//用户修改自己的信息API接口调用
export default class ModUserMessage extends React.Component {
    ...
    handleOnClick = () => {
        ...
        //用户修改自己的信息
        put("/datacenter/v1/member", {data}, headers).then(
          (res) => {
