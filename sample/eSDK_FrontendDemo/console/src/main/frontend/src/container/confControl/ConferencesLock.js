...
import { isLockBody } from '@/component/custom/CommonConst'
...
let reqBody = JSON.stringify(isLockBody,null,4);
let resBody = '';
let displayValue = 'none';
let statusCodeAndresbody = '';
let defaultURLVal = "/conferences/{conferenceId}/lock";
let confAuthVal = '';
...
let proxyId;
//锁定/解锁会议API接口调用
export default class ConferencesLock extends React.Component {
    constructor () {
        super();
