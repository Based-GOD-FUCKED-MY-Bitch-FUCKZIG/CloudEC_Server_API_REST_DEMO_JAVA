...
export default class ModifyConf extends React.Component {
     constructor () {
        ...
        this.state = {   
            ...
            queryConfMode:queryConfModeCopy,
            ...
            <div style={{marginTop: '50px',marginLeft: '10%',width:'100%'}}>
                <div style={{width:'95%'}}>
                    ...
                    <div style={{float:'left',marginLeft: '20px',width:'60%'}}>
                        <Input addonBefore="URL" defaultValue="/conferences" readOnly/>
                    </div>
                </div> 
                    ...
                    <Tabs defaultActiveKey='2'>
                        ...
                        <TabPane tab="Params" key="2">
                            <div>
                                ...
                                <div style={{float:'left',height:'40px',width:'100%'}}><li><Input style={{width:'30%'}} readOnly value="status"/> : <Input style={{width:'60%'}} value={this.state.status} onChange={({target:{value}})=>{statusCopy=value;this.setState({status:value})}}/></li></div>
                                ...
                                <div style={{float:'left',height:'40px',width:'100%'}}><li><Input style={{width:'30%'}} readOnly value="queryConfMode"/> : <Input style={{width:'60%'}} value={this.state.queryConfMode} onChange={({target:{value}})=>{queryConfModeCopy=value;this.setState({queryConfMode:value})}}/></li></div>
