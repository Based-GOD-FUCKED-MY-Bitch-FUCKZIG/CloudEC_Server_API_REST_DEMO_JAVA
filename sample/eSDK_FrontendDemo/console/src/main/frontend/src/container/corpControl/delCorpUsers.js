...
import { delCorpUsersBody } from '@/component/custom/CommonConst'
...
let requestBody = JSON.stringify(delCorpUsersBody,null,4);
...
// let proxyId;
//批量删除用户API接口调用
export default class delCorpUsers extends React.Component {
    ...
    handleOnClick = () => {
        ...
        //批量删除用户
        post("/corp/member/delete", {data}, headers).then(
          (res) => {
            ...
            <div style={{marginTop: '50px',marginLeft: '10%',width:'100%'}}>
                <div style={{width:'95%'}}>
                    ...
                    <div style={{float:'left',marginLeft: '20px',width:'60%'}}>
                        <Input addonBefore="URL" defaultValue="/corp/member/delete" style={{width:'500px'}} readOnly/>
                    </div>
                </div>
