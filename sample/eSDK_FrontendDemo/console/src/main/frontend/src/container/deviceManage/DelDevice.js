...
import { DelDeviceBody } from '@/component/custom/CommonConst'
...
let reqBody = JSON.stringify(DelDeviceBody,null,4);
let resBody = '';
...
let proxyId;
//批量删除终端API接口调用
export default class DelDevice extends React.Component {
    constructor () {
        super();
            ...
            <div style={{marginTop: '50px',marginLeft: '10%',width:'100%'}}>
                <div style={{width:'95%'}}>
                    ...
                    <div style={{float:'left',marginLeft: '20px',width:'60%'}}>
                        <Input addonBefore="URL" defaultValue="/rest/usg/datacenter/v1/corp/device/delete" style={{width:'500px'}} readOnly/>
                    </div>
                </div>
