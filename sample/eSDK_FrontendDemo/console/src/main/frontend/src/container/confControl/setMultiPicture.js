...
import{ setMultiPictureBody } from '@/component/custom/CommonConst'
...
let URL='/conferences/{conferenceid}/setMultiPicture';
let Token;
let reqBody=JSON.stringify(setMultiPictureBody,null,4);
