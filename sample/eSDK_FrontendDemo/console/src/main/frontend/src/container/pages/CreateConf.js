...
import { createConfBody } from '@/component/custom/CommonConst'
...
let reqBody = JSON.stringify(createConfBody,null,4);
let resBody = '';
            ...
            <div style={{marginTop: '50px',marginLeft: '10%',width:'100%'}}>
                <div style={{width:'95%'}}>
                    ...
                    <div style={{float:'left',marginLeft: '20px',width:'60%'}}>
                        <Input addonBefore="URL" defaultValue="/conferences" style={{width:'500px'}} readOnly/>
                    </div>
                </div>
