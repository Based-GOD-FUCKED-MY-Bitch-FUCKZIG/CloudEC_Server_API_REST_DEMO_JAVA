...
import { pageQueryCorpUserBody } from '@/component/custom/CommonConst'
...
let requestBody = JSON.stringify(pageQueryCorpUserBody,null,4);
...
// let proxyId;
//分页查询用户API接口调用
export default class pageQueryCorpUser extends React.Component {
            ...
            <div style={{marginTop: '50px',marginLeft: '10%',width:'100%'}}>
                <div style={{width:'95%'}}>
                    ...
                    <div style={{float:'left',marginLeft: '20px',width:'60%'}}>
                        <Input addonBefore="URL" defaultValue="/corp/member/search" style={{width:'500px'}} readOnly/>
                    </div>
                </div>
