...
import { PageQueryCorpManagerBody } from '@/component/custom/CommonConst'
...
let requestBody = JSON.stringify(PageQueryCorpManagerBody,null,4);
...
// let proxyId;
//分页查询企业管理员API接口调用
export default class PageQueryCorpManager extends React.Component {
            ...
            <div style={{marginTop: '50px',marginLeft: '10%',width:'100%'}}>
                <div style={{width:'95%'}}>
                    ...
                    <div style={{float:'left',marginLeft: '20px',width:'60%'}}>
                        <Input addonBefore="URL" defaultValue="/rest/usg/datacenter/v1/corp/admin/search" style={{width:'500px'}} readOnly/>
                    </div>
                </div>
