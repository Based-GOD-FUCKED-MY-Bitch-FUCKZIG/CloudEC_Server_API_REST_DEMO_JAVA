...
import { participantsRoleBody } from '@/component/custom/CommonConst'
...
let reqBody = JSON.stringify(participantsRoleBody,null,4);
let resBody = '';
let displayValue = 'none';
let statusCodeAndresbody = '';
let defaultURLVal = "/conferences/{confId}/participants/{participantId}/role";
let confAuthVal = '';
...
let proxyId;
//申请/释放主席API接口调用
export default class ParticipantsRole extends React.Component {
    constructor () {
        super();
