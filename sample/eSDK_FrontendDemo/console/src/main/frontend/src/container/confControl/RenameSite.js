...
import{ renameSiteBody } from '@/component/custom/CommonConst'
...
var URL = '/conferences/{conferenceid}/participants/rename';
var reqBody = JSON.stringify(renameSiteBody,null,4);
