...
var URL = '/cms/open/rest/confctl/{conferenceid}/realTimeInfo';
...
let proxyId;
//查询会议实时信息API接口调用
export default class GetRealTimeInfo extends React.Component {
     constructor () {
         super();
                    ...
                    <Tabs defaultActiveKey="1">
                        ...
                        <TabPane tab="Headers" key="1"> 
                            <div>
                                ...
                                <div style={{float:'left',height:'40px',width:'100%'}}><li><Input style={{width:'30%'}} readOnly value="Conference-Authorization"/> : <Input style={{width:'60%'}}  value={this.state.confAuth} onChange={({target:{value}})=>{confAuthVal=value; this.setState({confAuth:value})}}/></li></div>
                                </ul>
                            </div>
                        </TabPane>
