...
import { modCorpUserBody } from '@/component/custom/CommonConst'
...
let requestBody = JSON.stringify(modCorpUserBody,null,4);
...
// let proxyId;
//修改用户API接口调用
export default class modCorpUser extends React.Component {
