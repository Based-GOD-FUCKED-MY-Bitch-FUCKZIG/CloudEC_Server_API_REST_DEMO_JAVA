...
import { ResetDeviceCodeBody } from '@/component/custom/CommonConst'
...
let URL='/rest/usg/datacenter/v1/corp/device/{sn}/activecode';
let reqBody = JSON.stringify(ResetDeviceCodeBody,null,4);
let resBody = '';
...
let proxyId;
//重置激活码API接口调用
export default class ResetDeviceCode extends React.Component {
    constructor () {
        super();
