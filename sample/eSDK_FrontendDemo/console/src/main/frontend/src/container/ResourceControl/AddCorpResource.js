...
import { addCorpResourceBody } from '@/component/custom/CommonConst'
...
let requestBody = JSON.stringify(addCorpResourceBody,null,4);
...
// let proxyId;
//企业新增资源发放API接口调用
class AddCorpResource extends React.Component {
...
export default AddCorpResource
