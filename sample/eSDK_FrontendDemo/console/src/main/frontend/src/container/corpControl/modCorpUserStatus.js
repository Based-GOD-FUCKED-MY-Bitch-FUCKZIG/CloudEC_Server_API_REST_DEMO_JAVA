...
import { modCorpUserStatusBody } from '@/component/custom/CommonConst'
...
let requestBody = JSON.stringify(modCorpUserStatusBody,null,4);
var URL = "/corp/member/status/{value}";
...
// let proxyId;
//批量修改用户状态API接口调用
export default class modCorpUserStatus extends React.Component {
