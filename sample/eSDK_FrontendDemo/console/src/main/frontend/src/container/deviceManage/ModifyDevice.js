...
import { ModifyDeviceBody } from '@/component/custom/CommonConst'
...
let URL='/rest/usg/datacenter/v1/corp/device/{sn}';
let reqBody = JSON.stringify(ModifyDeviceBody,null,4);
let resBody = '';
