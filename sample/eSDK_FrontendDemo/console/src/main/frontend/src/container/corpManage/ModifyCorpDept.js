...
import { ModifyCorpDeptBody } from '@/component/custom/CommonConst'
...
let reqBody = JSON.stringify(ModifyCorpDeptBody,null,4);
let resBody = '';
let displayValue = 'none';
let statusCodeAndresbody = '';
let URL = "/rest/usg/datacenter/v1/corp/dept/{deptCode}"
...
// let proxyId;
//修改部门API接口调用
export default class ModifyCorpDept extends React.Component {
    constructor () {
        super();
        this.state = {
