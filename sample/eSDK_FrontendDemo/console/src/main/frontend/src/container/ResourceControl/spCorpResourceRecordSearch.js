...
import { spCorpResourceRecordSearchBody } from '@/component/custom/CommonConst'
...
let requestBody = JSON.stringify(spCorpResourceRecordSearchBody,null,4);
let URL = "/sp/corp/{corpId}/resource-record/search";
...
let server;
// let proxyId;
//SP根据条件查询企业的资源操作记录API接口调用
class spCorpResourceRecordSearch extends React.Component {
...
export default spCorpResourceRecordSearch
