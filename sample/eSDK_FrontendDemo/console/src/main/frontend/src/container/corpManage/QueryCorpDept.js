...
let URL = "/rest/usg/datacenter/v1/member/dept"
let deptName='';
...
// let proxyId;
//按名称查询部门API接口调用
export default class QueryCorpDept extends React.Component {
    constructor () {
        super();
        this.state = {
    ...
    handleOnClick = () => {
        ...
        //按名称查询部门
        get(url+"?deptName="+this.state.deptName, headers).then(
            (res) => {
            ...
            <div style={{marginTop: '50px',marginLeft: '10%',width:'100%'}}>
                <div style={{width:'95%'}}>
                    ...
                    <div style={{float:'left',marginLeft: '20px',width:'60%'}}>
                        <Input addonBefore="URL" value={this.state.url} readOnly/>
                    </div>
                </div>
                ...
                <div style={{clear:'both'}}>
                    <Tabs defaultActiveKey="1">
                        ...
                        <div style={{width:'100%'}}>
                                <ul>
                                    <li><Input style={{width:'20%'}} readOnly value="deptName"/> : <Input style={{width:'60%'}} value={this.state.deptName} onChange={({target:{value}})=>{deptName=value;this.setState({deptName:value})}}/></li>
                                </ul>
                            </div>
                        </TabPane>
