...
import { AddCorpBody } from '@/component/custom/CommonConst'
...
let reqBody = JSON.stringify(AddCorpBody,null,4);
let resBody = '';
...
// let proxyId;
//创建企业API接口调用
export default class AddCorp extends React.Component {
    constructor () {
        super();
        this.state = {
    ...
    handleOnClick = () => {
      ...
      post("/rest/usg/datacenter/v1/sp/corp", {data}, headers).then(
        (res) => {
            ...
            <div style={{marginTop: '50px',marginLeft: '10%',width:'100%'}}>
                <div style={{width:'95%'}}>
                    ...
                    <div style={{float:'left',marginLeft: '20px',width:'60%'}}>
                        <Input addonBefore="URL" defaultValue="/rest/usg/datacenter/v1/sp/corp" style={{width:'500px'}} readOnly/>
                    </div>
                </div>
