...
// let proxyId;
//批量删除企业管理员API接口调用
export default class DelCorpManager extends React.Component {
            ...
            <div style={{marginTop: '50px',marginLeft: '10%',width:'100%'}}>
                <div style={{width:'95%'}}>
                    ...
                    <div style={{float:'left',marginLeft: '20px',width:'60%'}}>
                        <Input addonBefore="URL" defaultValue="/rest/usg/datacenter/v1/corp/admin/delete" style={{width:'500px'}} readOnly/>
                    </div>
                </div>
