...
import { spCorpResourceSearchBody } from '@/component/custom/CommonConst'
...
let requestBody = JSON.stringify(spCorpResourceSearchBody,null,4);
let URL = "/sp/corp/{corpId}/resource/search";
...
let server;
// let proxyId;
//SP根据条件查询企业的资源项API接口调用
export default class spCorpResourceSearch extends React.Component {
